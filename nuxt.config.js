  ...
  app: {
    head: {
      ...
      meta: [
        ...
        // { hid: 'og-image', property: 'og:image', content: `${process.env.BASE_APP_URL}/logos/cartera-cm-logo-512.png` },
      ],
      link: [
        { rel: 'icon', type: 'image/x-icon', href: '/favicon.ico' },
        { rel: 'mask-icon', href: '/favicon.ico', color: '#FFFFFF' },
        { rel: 'manifest', href: '/site.webmanifest' },
        // { rel: 'apple-touch-icon', sizes: '192x192', href: '/logos/cartera-cm-logo-192.png' },
        // { rel: 'apple-touch-icon', sizes: '512x512', href: '/logos/cartera-cm-logo-512.png' },
      ],
    },
  },
  srcDir: 'src/',
